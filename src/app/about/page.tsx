    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
        ...
        <div className="space-y-6">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-3">{t("aboutExperienceTitle")}</h2>
            <p className="text-gray-600 leading-relaxed">{t("aboutExperience")}</p>
          </section>
          
          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-3">{t("aboutTechnologyTitle")}</h2>
            <p className="text-gray-600 leading-relaxed">{t("aboutTechnology")}</p>
          </section>
          
          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-3">{t("aboutCommitmentTitle")}</h2>
